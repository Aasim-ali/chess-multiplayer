...
const Header = () => {
  ...
  return (
    <div className='flex w-full justify-around items-center h-[10%] text-white font-[cursive] border-b-1 border-white mb-8'>
        <div className='font-bold text-[1.5rem] sm:text-[2rem]'>
            <span>Chess</span>
        </div>
        <div className='flex gap-6 sm:gap-12 h-full items-center text-[.8rem] sm:text-xl'>
            <Link
              to="/" 
